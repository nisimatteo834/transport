...
cat $file_out_p | grep Torino > temp.dat
...
cat $file_out_b | grep Torino > temp.dat
...
cat $file_out_b_nf | grep Torino > temp.dat
...
#cat $file_out_p_nf | grep Torino > temp.dat
