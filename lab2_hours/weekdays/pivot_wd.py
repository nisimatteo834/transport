...
if __name__ == '__main__':
    ...
    #enjoy = pd.read_excel(folder+'/carsharing_wd.xlsx','enjoy')
    #car2go = pd.read_excel(folder+'/carsharing_wd.xlsx','car3go')
    #total = pd.read_excel(folder+'/carsharing_wd.xlsx','Total')
    enjoy = pd.read_excel(folder+'/carsharing_wd.xlsx','Sheet3')
    car2go = pd.read_excel(folder+'/carsharing_wd.xlsx','Sheet4')
    total = pd.read_excel(folder+'/carsharing_wd.xlsx','Sheet5')
#%%Normalizing
