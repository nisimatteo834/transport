...
if __name__ == '__main__':
    folder = 'C:\\Users\\Matteo\\Desktop\\lab1es2\\transport\\lab2\\allincsv'
    #folder = '.'
                    ...
                    for k in range(1,len(scopo_list)+1):
                        ...
                        for scopo in sub_scopo:
                            ...
                            if(size==(23,23)):
                                ...
                                file.write(sex+','+fascia+','+scopo+','+str(distance_enjoy.sum())+','+str(distance_car2go.sum())+','+str(distance_total.sum())+'\n')
                                print(str(sex)+','+str(fascia)+','+str(scopo)+','+str(distance_enjoy.sum())+','+str(distance_car2go.sum())+','+str(distance_total.sum())+'\n')
