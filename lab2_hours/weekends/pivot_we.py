...
if __name__ == '__main__':
    ...
    #enjoy = pd.read_excel(folder+'/carsharing_we.xlsx','enjoy')
    #car2go = pd.read_excel(folder+'/carsharing_we.xlsx','car3go')
    #total = pd.read_excel(folder+'/carsharing_we.xlsx','Total')
    enjoy = pd.read_excel(folder+'/carsharing_we.xlsx','Sheet3')
    car2go = pd.read_excel(folder+'/carsharing_we.xlsx','Sheet4')
    total = pd.read_excel(folder+'/carsharing_we.xlsx','Sheet5')
#%%Normalizing
