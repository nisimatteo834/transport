...
# mongo bigdatadb.polito.it/carsharing --ssl --sslAllowInvalidCertificates -u ictts -p 'Ictts16!' --authenticationDatabase carsharing lab1_2_1_parking_nofilter.js > temp4.dat
# echo 'Done'
...
# cat temp4.dat | grep Madrid > parking_nf_MA.dat
# cat temp4.dat | grep Torino > parking_nf_TO.dat
# cat temp4.dat | grep New > parking_nf_NY.dat
echo "Done"
