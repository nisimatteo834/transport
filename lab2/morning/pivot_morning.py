...
if __name__ == '__main__':
    ...
    #enjoy = pd.read_excel(folder+'/carsharing_morning.xlsx','enjoy')
    #car2go = pd.read_excel(folder+'/carsharing_morning.xlsx','car3go')
    #total = pd.read_excel(folder+'/carsharing_morning.xlsx','Total')
    enjoy = pd.read_excel(folder+'/carsharing_morning.xlsx','Sheet3')
    car2go = pd.read_excel(folder+'/carsharing_morning.xlsx','Sheet4')
    total = pd.read_excel(folder+'/carsharing_morning.xlsx','Sheet5')
#%%Normalizing
