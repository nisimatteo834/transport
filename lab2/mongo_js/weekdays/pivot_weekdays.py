...
if __name__ == '__main__':
    ...
    #enjoy = pd.read_excel(folder+'/carsharing_weekdays.xlsx','enjoy')
    #car2go = pd.read_excel(folder+'/carsharing_weekdays.xlsx','car3go')
    #total = pd.read_excel(folder+'/carsharing_weekdays.xlsx','Total')
    enjoy = pd.read_excel(folder+'/carsharing_weekdays.xlsx','Sheet3')
    car2go = pd.read_excel(folder+'/carsharing_weekdays.xlsx','Sheet4')
    total = pd.read_excel(folder+'/carsharing_weekdays.xlsx','Sheet5')
#%%Normalizing
