...
if __name__ == '__main__':
    ...
    #enjoy = pd.read_excel(folder+'/carsharing_weekends.xlsx','enjoy')
    #car2go = pd.read_excel(folder+'/carsharing_weekends.xlsx','car3go')
    #total = pd.read_excel(folder+'/carsharing_weekends.xlsx','Total')
    enjoy = pd.read_excel(folder+'/carsharing_weekends.xlsx','Sheet3')
    car2go = pd.read_excel(folder+'/carsharing_weekends.xlsx','Sheet4')
    total = pd.read_excel(folder+'/carsharing_weekends.xlsx','Sheet5')
#%%Normalizing
